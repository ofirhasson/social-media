...
//   public readonly userImageUrl = process.env.USER_IMAGE_URL;
  public readonly commentImageUrl = process.env.COMMENT_IMAGE_URL;
  public readonly postsImageUrl = process.env.POSTS_IMAGE_URL;
}
