...
export function PostCard({ post }: PostCardProps): JSX.Element {
  const {
   ...
   updateComment,
    ...
    editCommentText,
    commentBeingEdited,
    openCommentEditField,openTextareaEditComment,comments
  } = usePostCard(post);

  

  //   const openModalWithLikes = () => {
  //     setModalContent(
  //       <div>
  //         {/* Render only likes here */}
  //         {post.likes.map((like) => (
  //           <div key={like._id} className="flex items-center mb-2">
  //             <img
  //               className="w-8 h-8 rounded-full"
  //               src={like.userId.profileImage || "default-profile.jpg"}
  //               alt="User"
  //             />
  //             <span className="ml-2 text-gray-800 dark:text-gray-100">
  //               {like.userId.userDetails.firstName +
  //                 " " +
  //                 like.userId.userDetails.lastName}
  //             </span>
  //           </div>
  //         ))}
  //       </div>
  ...
  return (
    <>
      <div className="p-4 md:p-8 bg-gray-50 dark:bg-gray-900 flex items-center justify-center w-full h-full">
        <div className="px-5 py-4 bg-white dark:bg-gray-800 shadow rounded-lg w-full max-w-lg">
          ...
          <div className="flex justify-between items-center mt-5">
            ...
            <div
              ...
              onClick={openModalWithPostAndAllCommentsAndReplies}
            >
                ...
                <div>
                  ...
                  <div className="relative">
                    {comment.replies.slice(0, 1).map((reply) => (
                      <div
                        key={reply?._id}
                        className="mb-3 w-full bg-gray-300 "
                      >
                        <div className="flex  items-center">
                          <img
        ...
        <Modal
          component={
            <PostModalContent
              ...
              addReply={addReply}
              handleClickDotsButton={handleClickDotsButton}
              ...
              openCommentDotes={openCommentDotes}
              openReplyTextField={openReplyTextField}
              post={post}
              registerComment={registerComment}
              registerCommentName="text"
              registerReply={registerReply}
              registerReplyName="text"
              userId={userId}
              ...
              openCommentEditField={openCommentEditField}
              registerEditComment={registerEditComment}
              updateComment={updateComment}
              openTextareaEditComment={openTextareaEditComment}
